...
UpdateRecords() {
  ...
  //   let bodyData = {
  //     // initialise form group here
  //     this:this.customerForm = this.formBuilder.group({
  //       customername: this.customerForm.customername,
  //       customeraddress: this.customerForm.customeraddress,
  ...
  //   //   this: FormGroup<{
  //   //     customername: FormControl<customerForm>;
  //   //     customeraddress: FormControl<customerForm>;
  //   //     mobile: FormControl<customerForm>;
  //   // }>
  ...
  //   this.customerForm.customeraddress = data.customeraddress;
  //   this.customerForm.mobile = data.mobile;
  //   this.customerForm.currentCustomerID = data.customerid;
  // }
